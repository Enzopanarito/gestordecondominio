...
module.exports={WRITE_HANDLERS,HARD_BLOCKED,WHATSAPP_PREFIX,clean,activationFingerprint,isWrite,effectiveDataEnvironment,effectiveWriteMode,effectiveBaseId,validateBasePair,authorize};
