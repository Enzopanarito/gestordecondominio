...
export const PUBLIC_FILES=Object.freeze([
  ...
  'owner-payment-report-v3.css','owner-payment-report-v3.js','owner-breakdown-v7.css',
  'owner-breakdown-v7.js','payment-report-intelligence.js','vla-finance-v7.js',
  'pwa-register.js','release.json','service-worker.js'
]);
...
function writeHandlerMap(){
  ...
  const lines=["'use strict';","const map=Object.create(null);"];
...
async function main(){
  ...
  const handlerEntries=HANDLERS.map(name=>`netlify/functions/${name}.js`);
  ...
  const manifest={schema:'vla-failover-vendor-manifest-v1',generatedAt:new Date().toISOString(),sourceRepository:lock.sourceRepository,sourceCommit:lock.sourceCommit,sourceRelease:release.release,handlers:HANDLERS,staticFiles:staticManifest,codeFiles:codeManifest};
